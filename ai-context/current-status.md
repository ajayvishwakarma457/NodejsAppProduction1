...
Production-ready API backend. All core modules implemented, 282 unit tests and 90 HTTP integration tests passing.
...
- Vitest unit test suite under `src/tests/unit/` (282 tests)
...
- Idempotency key middleware for safe retries, backed by Redis with request fingerprinting, concurrent-request locking, and configurable TTL
