...
(0, vitest_1.describe)('jobOrchestrator', () => {
    ...
    (0, vitest_1.it)('should return health stats for all jobs', async () => {
        ...
        (0, vitest_1.expect)(legacyJobs).toHaveLength(3);
        (0, vitest_1.expect)(legacyJobs.map((h) => h.name)).toEqual(vitest_1.expect.arrayContaining(['email', 'notification', 'reminder']));
    ...
    (0, vitest_1.it)('should start and stop all jobs without crashing', async () => {
        ...
        await (0, vitest_1.expect)(jobs_1.jobOrchestrator.stopAll()).resolves.toBeUndefined();
    });
    (0, vitest_1.it)('should reflect queue changes in health stats', async () => {
        ...
        (0, vitest_1.expect)(emailHealth).toBeDefined();
        (0, vitest_1.expect)(emailHealth && 'queueSize' in emailHealth).toBe(true);
